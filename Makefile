# This Makefile is for the Class::Data::TIN extension to perl.
#
...
#     ABSTRACT_FROM => q[TIN.pm]
#     AUTHOR => q[Thomas Klausner (domm@zsi.at)]
#     NAME => q[Class::Data::TIN]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[TIN.pm]
...
FULLEXT = Class/Data/TIN
BASEEXT = TIN
PARENT_NAME = Class::Data
DLBASE = $(BASEEXT)
VERSION_FROM = TIN.pm
OBJECT = 
LDFROM = $(OBJECT)
...
INST_LIBDIR      = $(INST_LIB)/Class/Data
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Class/Data
...
DISTNAME = Class-Data-TIN
DISTVNAME = Class-Data-TIN-0.05
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  TIN.pm $(INST_MAN3DIR)/Class::Data::TIN.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Class-Data-TIN' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.05' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: TIN.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Translucent Inheritable Nonpolluting Class Data</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Thomas Klausner (domm@zsi.at)</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  TIN.pm $(INST_LIB)/Class/Data/TIN.pm 
